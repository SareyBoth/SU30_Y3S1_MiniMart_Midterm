    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="{{ route('dashboard.sub_category.update', $sub_category->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="circular-upload" style="margin: 36px 0;">
                                <div class="image-preview" id="image-preview"
                                    ...
                                    style="background-image: url('{{ asset('storage/' . $sub_category->image) }}'); background-size: cover; background-position: center;"
                                    @endif>
                                    <div class="label-text text-primary" id="label-text" @if($sub_category->image) style="opacity: 0;" @endif>
                                        Add image
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="name" value="{{ old('name', $sub_category->name) }}" class="form-control"
                                            placeholder="Input sub category name" type="text" required>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" style="height: 220px"
                                        placeholder="Describe everything about the sub category">{{ old('description', $sub_category->description) }}</textarea>
                                </div>
                            </div>

                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" type="submit">Update Sub Category</button>
                            </div>
                        </form>
                    </div>
                </div>
