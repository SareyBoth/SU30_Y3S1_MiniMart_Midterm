    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="">
                    <form action="{{ route('dashboard.sub_category.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-8 offset-lg-2">
                            <form action="{{ route('dashboard.sub_category.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="col-lg-8 offset-lg-2">
                                    ...
                                    <div class="m-t-20 text-center">
                                        <button type="submit" class="btn btn-primary submit-btn">Create Sub Category</button>
                                    </div>
