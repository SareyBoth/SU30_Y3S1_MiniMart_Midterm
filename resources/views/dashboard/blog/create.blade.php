...
<body>
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="">
                    <form id="blog-form" action="{{ route('dashboard.blog.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-lg-8 ">
                                ...
                                <div class="circular-upload" style="margin: 36px 0;">
                                    <div class="image-preview" id="image-preview"
                                        style="background-image: url('{{ old('image') ? asset('storage/' . old('image')) : '' }}')">
                                        <div class="label-text text-primary" id="label-text"
                                            style="opacity: {{ old('image') ? '0' : '1' }};">Add Cover</div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="meta_description" class="form-control" rows="3"
                                                placeholder="Input meta description for SEO">{{ old('meta_description') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- Removed required to avoid "not focusable" error -->
                                    <textarea name="body" id="mytextarea" class="form-control" style="height: 220px"
                                        placeholder="Write the full content of your blog post">{{ old('body') }}</textarea>
                                    @error('body')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="m-t-20 text-center">
                                    <button type="submit" class="btn btn-primary submit-btn">Create Blog Post</button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <script>
        document.getElementById('blog-form').addEventListener('submit', function(e) {
            // Force TinyMCE to save its content to the original textarea
            tinymce.triggerSave();
        });
