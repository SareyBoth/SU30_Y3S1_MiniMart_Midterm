                            ...
                            <table class="table table-striped custom-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>${{ number_format($discount->minimum_purchase, 2) }}</td>
                                        <td>{{ $discount->valid_until ? $discount->valid_until->format('M d, Y') : 'Never' }}</td>
                                        ...
                                        <td class="text-center">
                                            <a href="#" class="delete-btn" data-toggle="modal" data-target="#delete_modal" title="Delete" data-id="{{ $discount->id }}">
