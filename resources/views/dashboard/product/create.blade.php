                            ...
                            <div class="col-lg-8 offset-lg-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="sub_category_id" id="subcategory-select" class="form-control" disabled>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="stock_quantity" class="form-control" placeholder="Input quantity" type="number" step="1" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" style="height: 220px" placeholder="Describe everything about the product"></textarea>
                                    </div>
                                </div>

                                <div class="m-t-20 text-center">
                                    <button type="submit" class="btn btn-primary submit-btn">Create Product</button>
                                </div>
